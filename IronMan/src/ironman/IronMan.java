...
public class IronMan {
    ...
    public static void main(String[] args) {
        ...
        Rockwell. Todas las armaduras poseen 
        ...
        a) Al caminar la armadura hará un uso básico de las botas y se consumirá la energía 
        establecida como consumo en la bota por el tiempo en el que se camine. 
        b) Al correr la armadura hará un uso normal de las botas y se consumirá el doble de la 
        energía establecida como consumo en la bota por el tiempo en el que se corra. 
        c) Al propulsarse la armadura hará un uso intensivo de las botas utilizando el triple de la 
        energía por el tiempo que dure la propulsión. 
        d) Al volar la armadura hará un uso intensivo de las botas y de los guantes un uso normal 
        consumiendo el triple de la energía establecida para las botas y el doble para los 
        guantes. 
        e) Al utilizar los guantes como armas el consumo se triplica durante el tiempo del 
        disparo.
        f) Al utilizar las botas para caminar o correr el consumo es normal durante el tiempo 
        que se camina o se corra. 
        g) Cada vez que se escribe en la consola o se habla a través del sintetizador se consume 
        lo establecido en estos dispositivos. Solo se usa en nivel básico. 
        h) Cada vez que se efectúa una acción se llama a los métodos usar del dispositivo se le 
        ...
        La armadura solo podrá utilizar dispositivos que no se encuentren dañados. Modifique las 
        clases que sean necesarias para llevar adelante este comportamiento. 
